...
function initPayment() {
    if (validate()) {
        ...
        const cust_email = document.getElementById("akalankainduwara123@outlook.com").value;
        const cust_mobile = document.getElementById("+94 779340440").value;
        const cust_address = "pussellawa";
